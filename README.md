...
The result screen includes **Copy log** and **Share log** actions. The diagnostic log is plain text and includes the sampled frame number/time, detector counts, qualified face boxes, appearance frame ranges, candidate frames, identity cluster membership, and final counts.
